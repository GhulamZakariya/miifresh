...
class Order {
  ...
  String excludedProductCategories;
  String freeShipping;
  String productIds;
  String orderedSource;
  ...
  String ordersToDeliveryboyId;
  String deliveryboyId;
  String isCurrent;
  String ordersStatusId;
  String ordersStatus;
  ...
  Order.fromJson(Map<String, dynamic> json) {
    ...
    excludeProductIds = json['exclude_product_ids'];
    ...
    ordersToDeliveryboyId = json['orders_to_deliveryboy_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['exclude_product_ids'] = this.excludeProductIds;
    ...
    data['orders_to_deliveryboy_id'] = this.ordersToDeliveryboyId;
