...
class ApiProvider {
  ...
  Future<ZonesResponse> getZones(String countryId) async {
    try {
      Response response = await _dio.post(
        _baseUrl + "getzones",
  ...
  Future<LikeProductResponse> likeProduct(String productId) async {
    try {
      Response response = await _dio.post(
  ...
  Future<LikeProductResponse> unlikeProduct(String productId) async {
    try {
      Response response = await _dio.post(
