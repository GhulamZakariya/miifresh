...
class HomePage6 extends StatefulWidget {
  ...
  HomePage6(this.isHeaderVisible, this._toProductDetailPage);

  @override
  _HomePage6State createState() => _HomePage6State(isHeaderVisible);
}
...
class _HomePage6State extends State<HomePage6> {
  ...
  _HomePage6State(this.isHeaderVisible);
          ...
          return InkWell(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => Shop(categories[index].categoriesId as int,
