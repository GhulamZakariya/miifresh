...
class HomePage10 extends StatefulWidget {
  ...
  HomePage10(this.isHeaderVisible, this._toProductDetailPage);

  @override
  _HomePage10State createState() => _HomePage10State(isHeaderVisible);
}
...
class _HomePage10State extends State<HomePage10> {
  ...
  _HomePage10State(this.isHeaderVisible);
