...
class HomePage4 extends StatefulWidget {
  ...
  HomePage4(this.isHeaderVisible, this._toProductDetailPage);

  @override
  _HomePage4State createState() =>
      _HomePage4State(isHeaderVisible, _toProductDetailPage);
}
...
class _HomePage4State extends State<HomePage4> {
  ...
  _HomePage4State(this.isHeaderVisible, this._toProductDetailPage);
        ...
        return InkWell(
          onTap: () {
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        Shop(categories[index].categoriesId as int, "newest", true, _toProductDetailPage)));
